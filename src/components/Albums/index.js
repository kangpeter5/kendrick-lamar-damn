		...
		<div className="album">
			<div className="album-section">
				...
				<div className="album-desc">
					...
					<a href="http://pitchfork.com/reviews/albums/15653-section80/">Pitchfork</a>
					<a href="http://www.xxlmag.com/news/2017/04/kendrick-lamars-section-80-certified-gold/">XXL</a>
				</div>
			</div>
			<div className="album-section">
				<iframe className="album-yt" width="560" height="315" src="https://www.youtube.com/embed/GF8aaTu2kg0?list=PLqZcp8_6M275I4Cu0yreysTw9R9ZyZNGr" frameborder="0" allowfullscreen></iframe>
				<div className="album-desc">
					...
					<a href="http://pitchfork.com/reviews/albums/17253-good-kid-maad-city/">Pitchfork</a>
					<a href="http://www.complex.com/music/2012/10/the-making-of-kendrick-lamars-good-kid-maad-city/before-the-album">Complex</a>
				</div>
			</div>
			...
			<div className="album-section">
				...
				<div className="album-desc">
					...
					<a className="reference-link" href="https://en.wikipedia.org/wiki/Damn_(Kendrick_Lamar_album)">Reference</a></p>
					<a href="http://pitchfork.com/reviews/albums/20390-to-pimp-a-butterfly/">Pitchfork</a>
					<a href="http://www.xxlmag.com/news/2017/01/kendrick-lamars-to-pimp-a-butterfly-archived-harvard-library/">XXL</a>
				</div>
			</div>
			<div className="album-section">
				<iframe className="album-yt" width="560" height="315" src="https://www.youtube.com/embed/NLZRYQMLDW4?list=PLxKHVMqMZqUTMHeEmiAn8uylx3W_u8KI5" frameborder="0" allowfullscreen></iframe>
				<div className="album-desc">
					<h3>Damn</h3>
					<p>Damn received widespread acclaim from critics. At Metacritic, which assigns a normalized rating out of 100 to reviews from mainstream publications, the album received an average score of 96, based on 37 reviews.[26] Andy Kellman of AllMusic stated that "It contains some of Lamar's best writing and performances, revealing his evolving complexity and versatility as a soul-baring lyricist and dynamic rapper." Christopher R. Weingarten, an author for Rolling Stone, said, "Much like the recent A Tribe Called Quest record, Damn. is a brilliant combination of the timeless and the modern, the old school and the next-level. The most gifted rapper of a generation stomps into the Nineties and continues to blaze a trail forward."[35] Writing for The A.V. Club, Evan Rytlewski concluded, "Lamar trusts every idea to stand on its own. When you're making art this substantial, vital, and virtuosic, there's no need to wrap a tidy bow around it." In his review, Greg Kot of Chicago Tribute states, "Damn. strips down the rhythms to their essence, flavored with the occasional cameo (notably Rihanna and U2). Lamar's voice does most of the heavy lifting, playing multiple roles and characters. His supple singing complements a variety of rap tones and textures."
					<a className="reference-link" href="https://en.wikipedia.org/wiki/Damn_(Kendrick_Lamar_album)">Reference</a></p>
					<a href="http://pitchfork.com/reviews/albums/23147-damn/">Pitchfork</a>
					<a href="http://www.xxlmag.com/rap-music/reviews/2017/04/kendrick-lamar-damn-album-review/">XXL</a>
				</div>
			</div>
		</div>
    );
